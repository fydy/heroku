 ...
 */
/* * ***********SYSTEM SETTINGS****************** */
define('USEYOURDRIVE_VERSION', '1.11.4');
    ...
    public function ask_for_review($force = false) {
        ...
        <div class="enjoying-container go-for-it" style="display:none">
          ...
          <div class="enjoying-buttons">
            ...
            <a class="enjoying-button default" id="enjoying-button-go-for-it-yes" href="https://codecanyon.net/item/useyourdrive-google-drive-plugin-for-wordpress/reviews/6219776?ref=_DeLeeuw_" target="_blank"><?php _e('Ok, sure!', 'useyourdrive'); ?></a>
          </div>
        </div>
