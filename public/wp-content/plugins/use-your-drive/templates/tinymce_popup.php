            ...
            <div class="useyourdrive-panel useyourdrive-panel-right">
              ...
              <div id="settings_folders" class="useyourdrive-tab-panel">
                ...
                <div class="option option-userfolders forfilebrowser foruploadbox forgallery <?php echo (isset($_REQUEST['userfolders'])) ? '' : 'hidden'; ?>">
                  ...
                  <div class="useyourdrive-option-description"><?php _e('Do you want to link your users manually to their private or should the plugin handle this automatically for you', 'useyourdrive'); ?>.</div>
                  ...
                  <div class="option-userfolders_auto">
                    ...
                    <div class="useyourdrive-option-description">
                      <?php _e('Newly created Private Folders can be prefilled with files from a template template', 'useyourdrive'); ?>. <?php _e('The content of the template folder selected will be copied to the user folder', 'useyourdrive'); ?>.
                    </div>
