...
?>
<?php get_header(); ?>
<?php $imgurl=zm_get_option('reg_img');echo'<style type="text/css">body.custom-background{background: url('.$imgurl.');}body{background: url('.$imgurl.')}</style>'?>
					...
					<div class="reg-content">
						...
						if (!is_user_logged_in()) { ?>
							<form name="registerform" method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>" class="user_reg">
								...
								<?php if ( zm_get_option('custom_register') == '' ) { ?>
								    <p>
								...
								<?php if (zm_get_option('invitation_code')) { ?>
									...
									<input name="invitation_code" type="text" class="input" id="invitation_code" style="text-transform: uppercase" />
									</label>
