...
function allauthor() {
global $wpdb;
$authors = $wpdb->get_results("SELECT ID, user_login from $wpdb->users, $wpdb->usermeta WHERE meta_key = 'wp_user_level' AND meta_value >= 2 AND ID = user_id ORDER BY display_name");
