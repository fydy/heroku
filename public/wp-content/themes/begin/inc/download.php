		...
		if($down_start) {
			...
			<div class="down-form">
				<fieldset>
					...
					<span class="down">
						<a title="'.$begin_name.'" href="'.get_template_directory_uri().'/down.php?id='.get_the_ID().'" rel="external nofollow" target="_blank"><i class="be be-download"></i>下载地址</a>
						<!--down.php在网站根目录时使用-->
						<!--<a title="'.$begin_name.'" href="'.site_url().'/down.php?id='.get_the_ID().'" rel="external nofollow" target="_blank"><i class="be be-download"></i>下载地址</a>-->
					</span>
					<span class="down">
					 '.$demo_content.'
					</span>
