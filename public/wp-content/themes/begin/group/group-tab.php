		...
		<div class="group-tab-site">
			<div id="group-tab" class="group-tab-product">
			    <h2 class="group-tab-hd wow fadeInUp" data-wow-delay="0.3s">
				    ...
				    <?php if ( zm_get_option('sb_t') == '' ) { ?><?php } else { ?><span class="group-tab-hd-con"><a href="javascript:"><?php echo zm_get_option('sb_t'); ?></a></span><?php } ?>
			    </h2>

				<div class="group-tab-bd group-dom-display wow fadeIn" data-wow-delay="0.5s">

					<div class="group-tab-bd-con group-current">
						<?php query_posts( array( 'showposts' => zm_get_option('group_tab_n'), 'category__and' => zm_get_option('anli_id'), 'post__not_in' => $do_not_duplicate ) ); while (have_posts()) : the_post(); ?>
					...
					<div class="group-tab-bd-con">
						<?php query_posts( array( 'showposts' => zm_get_option('group_tab_n'), 'category__and' => zm_get_option('cp_id'), 'post__not_in' => $do_not_duplicate ) ); while (have_posts()) : the_post(); ?>
                    ...
                    <?php if ( zm_get_option('sb_t') == '' ) { ?><?php } else { ?>
					<div class="group-tab-bd-con">
						<?php query_posts( array( 'showposts' => zm_get_option('group_tab_n'), 'category__and' => zm_get_option('sb_id'), 'post__not_in' => $do_not_duplicate ) ); while (have_posts()) : the_post(); ?>
