				...
				<div id="owl" class="owl-carousel wow fadeIn" data-wow-delay="0.7s"">
					<?php 
						if (zm_get_option('group_gallery')) {
							...
							$loop = new WP_Query( array( 'category__and' => zm_get_option('group_carousel_id'), 'posts_per_page' => zm_get_option('carousel_n'), 'post__not_in' => get_option( 'sticky_posts'), 'post__not_in' => $do_not_duplicate ) );
						}
