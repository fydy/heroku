						...
						<div class="login_fields">
							<div class="rememberme">
								<label for="rememberme">
									<input type="checkbox" name="rememberme" value="forever" checked="checked" id="rememberme" /><?php _e( '记住我的登录信息', 'begin' ); ?>
								</label>
							</div>
							<input type="submit" name="user-submit" value="<?php _e( '登录', 'begin' ); ?>" class="user-submit" />
				...
				<div class="login-tab-bd-con">
					<div id="tab2_login" class="tab_content_login">
						<form method="post" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" class="wp-user-form">
							<div class="username">
								<label for="user_login"><?php _e( '用户名', 'begin' ); ?></label>
								<input type="text" name="user_login" value="<?php echo esc_attr(stripslashes($user_login)); ?>" size="20" id="user_reg" />
							</div>
							<div class="password">
